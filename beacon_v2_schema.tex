...
%, e.g. "self" (ERO:002036), "identical twin relationship" (ERO:0002041)
 ...
 % BIOSAMPLE
  ...
  \begin{description}
	...
	\end{itemize}
	\item[\textbf{obtentionProcedure}] {\textsc{categorical value (ontology label)}} Ontology ID from \href{http://purl.obolibrary.org/obo/NCIT_C25218}{NCI Thesaurus (NCIT) Intervention or Procedure (NCIT:C25218) ontology}. e.g. "biopsy" (NCIT:C15189) % (see "bronchoalveolar lavage", "nasopharyngeal swab" (?)
